      ...
      if (localStorage.getItem('storageContrast') != '1') {
        ...
        if (elements) {
          for (let i = 0; i < elements.length; i += 1) {
            ...
            if (tag.getAttribute('class') !== 'legendButton') tag.style.background = secondary;
            if (tag.getAttribute('class') === 'legendButton' && localStorage.getItem('storageContrast') === '4') {
            ...
            if (tag.getAttribute('class') === 'floatingIcon' && localStorage.getItem('storageContrast') === '4') tag.style.border = '1px solid black';
        ...
        if (elements) {
          for (let i = 0; i < elements.length; i += 1) {
            ...
            if (tag.getAttribute('class') === 'a11yIcon' || tag.getAttribute('class') === 'floatingIcon') tag.style.border = '1px solid black';
          }
        }
      }
    } catch (error) {
