...
/* eslint-disable */
type useReadyStateEffect = (effect: EffectCallback, deps?: any[], onState?: ExpectedReadyState) => void;

const useReadyStateEffect: useReadyStateEffect = (effect, deps = [], onState = 'complete'): void => {
  useEffect(() => {
...
function Libras({ forceOnload }: Props): JSX.Element {
  useReadyStateEffect(
    () => {
